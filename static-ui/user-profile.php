...
<main>
	<div class="container">
		...
		<form class="form-control-lg" id="form-profile" action="" method="post">
			...
			<div class="row justify-content-md-center">
				<div class="col-md-8">
					<button type="button" class="btn btn-primary text-light profile"><div class="my-btn" style="text-align:left;"><i class="fas fa-edit"></i>&nbsp;&nbsp;Update</div></button>
					<button type="button" class="btn btn-warning text-light profile" onclick="resetAll()"><div class="my-btn" style="text-align:left;"><i class="fas fa-undo"></i>&nbsp;&nbsp;Reset</div></button>
				</div><!--col-md-8-->
			</div><!--row-->
		</form>
	</div><!--		container-->
